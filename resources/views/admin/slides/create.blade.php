@component('admin.layouts.content',['title'=>' ایجاد اسلاید جدید   '])


    @slot('breadcromp')

        <li class="breadcrumb-item"><a href="{{route('admin.')}}">صفحه ی اصلی</a></li>
        <li class="breadcrumb-item active"><a> ایجاد اسلاید جدید</a></li>
    @endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <form class="form-horizontal"
                      action="{{ route('admin.slides.store') }}" method="POST"
