@component('admin.layouts.content',['title'=>' ایجادگالری تصویر جدید   '])


    @slot('breadcromp')

        <li class="breadcrumb-item"><a href="{{route('admin.')}}">صفحه ی اصلی</a></li>
        <li class="breadcrumb-item active"><a> ایجادگالری تصویر جدید</a></li>
    @endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <form class="form-horizontal"
                      action="{{ route('admin.product.gallery.store' , ['product' => $product->id]) }}" method="POST"
