@component('admin.layouts.content',['title'=>' مدیریت  نظرات تایید شده '])


    @slot('breadcromp')

        <li class="breadcrumb-item"><a href="{{route('admin.')}}">صفحه ی اصلی</a></li>
        <li class="breadcrumb-item active"><a>مدیریت نظرات تایید شده</a></li>
    @endslot
    <div class="card">
            ...
            <div class="card-tools ">
                <div class="input-group input-group-sm ">
                    <div class="d-flex align-items-center">
                        @if(request('search'))
                            <a href="{{route('admin.approvedcomments')}}" class="btn btn-outline-danger  ml-2">بازگشت
                            </a>
                        @endif
