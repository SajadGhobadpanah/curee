@component('admin.layouts.content',['title'=>' ایجاد خبر جدید '])
    ...
    @slot('breadcromp')
        ...
        <li class="breadcrumb-item"><a>ایجاد خبر جدید</a></li>
    @endslot
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">فرم ایجاد خبر </h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{route('admin.news.store')}}" method="post" class="form-horizontal">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="title" id="inputEmail3"
                               placeholder="عنوان خبر  را وارد کنید" value="{{old('title')}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name="content" class="form-control"  id="description" cols="30" rows="10">{{old('content')}}</textarea>
                    </div>
                </div>
